...
export default async function Profile() {
    ...
    return <>
        ...
        <div className="mt-20 ml-20 mr-20 flex gap-4 justify-between">
            ...
            <Card title="Países" img_url="/assets/countries.png" total={totalCountries} text={totalCountries > 1 ? `países` : `país`}/>
            <Card title="Cidades" img_url="/assets/cities.png" total={totalCities} text={totalCities > 1 ? `cidades` : `cidade`}/>
        </div>
